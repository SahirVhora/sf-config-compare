...
from config import REPORTS_DIR, REPORT_ACCESS_TOKEN
...
def api_pull_history_detail(instance_id: int, history_id: int):
    ...
    from core.db import get_pull_history_by_id, get_entity_snapshots, get_picklist_snapshots
...
def api_scheduled_check_detail(check_id: int):
    from core.db import get_scheduled_check, update_scheduled_check, delete_scheduled_check
    if request.method == "GET":
